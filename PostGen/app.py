...
from fasthtml import html, form, state, styles, render_page
...
theme.add("""
.container { max-width: 720px; margin: auto; padding: 2rem; font-family: Arial, sans-serif; }
h1, h3 { color: #1e293b; }
textarea { width: 100%; padding: 10px; font-size: 1rem; }
button { background-color: #6366f1; color: white; border: none; padding: 0.5rem 1rem; font-size: 1rem; margin: 0.2rem; cursor: pointer; border-radius: 4px; }
.tab-container button { display: inline-block; }
...
def homepage(request: Request):
    content = render_page(request, layout=main_layout)
